...
export const metadata: Metadata = {
  ...
  title: { default: "Jike Peptide | B2B Manufacturing & OEM Supply", template: "%s | Jike Peptide" },
  description: "B2B peptide manufacturing, OEM packaging, batch-specific analytical documentation and international fulfillment for qualified commercial buyers.",
  robots: { index: true, follow: true },
  openGraph: { title: "Jike Peptide", description: "B2B manufacturing, OEM packaging and batch-specific analytical documentation for qualified commercial buyers.", url: "https://jikepeptide.bio", siteName: "Jike Peptide", type: "website" },
};
