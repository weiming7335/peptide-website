...
const salesExperts = [
  { name: "Christine", phone: "+1 213 703 8679", whatsapp: "https://wa.me/12137038679", image: "/images/team/christine.png" },
  { name: "Emma", phone: "+1 909 459 9735", whatsapp: "https://wa.me/19094599735", image: "/images/team/emma.png" },
  { name: "Luna", phone: "+852 9841 7612", whatsapp: "https://wa.me/85298417612", image: "/images/team/luna.png" },
];
...
export default function AboutPage() {
  return <><SiteHeader /><main><PageHero title="About us" />
    ...
    <section className="sales-experts section-pad"><div className="section-shell"><div className="sales-heading"><p className="eyebrow">MEET OUR TEAM</p><h2>Our Sales Experts</h2><p>Connect directly with our experienced sales team for product, documentation and order support.</p></div><div className="sales-grid">{salesExperts.map(expert=><article key={expert.name}><div className="sales-avatar"><Image src={assetPath(expert.image)} alt={`${expert.name}, Leaxion sales expert`} fill sizes="160px" /></div><span>SALES EXPERT</span><h3>{expert.name}</h3><a href={expert.whatsapp} target="_blank" rel="noreferrer"><WhatsAppIcon />{expert.phone}</a></article>)}</div></div></section>
